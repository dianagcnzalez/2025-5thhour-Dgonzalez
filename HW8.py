...
var = 3 +random.randint (1,20)
print (var)
#8. Make an if statement that prints if the variable from #7 is greater than, less than, or equal to A
if var > A+B+C:
    print ("variable is greater than A+B+C")
elif var < A+B+C:
    print ("variable is less than A+B+C")
else:
    print ("variable is equal to A+B+C")